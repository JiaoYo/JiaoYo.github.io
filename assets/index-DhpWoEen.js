import{_ as Ye}from"./round-plus-DB21dsS3.js";import{d as G,j as g,b as B,y as _e,aw as de,aG as ne,aK as h,aC as _,aX as je,az as C,aY as Le,aA as $,aB as ye,aZ as we,a_ as Ue,a$ as Fe,aD as We,b0 as pe,aE as xe,aF as ke,b1 as Ge,K as $e,b2 as Se,b3 as Xe,aJ as Ke,b4 as He,a4 as Je,b5 as Ze,aL as Qe,b6 as et,b7 as tt,b8 as ee,b9 as nt,ba as J,bb as at,bc as st,bd as lt,o as O,e as ae,f as j,a0 as rt,r as ot,g as a,A as H,X as fe,B as A,$ as se,an as F,h as P,L as me,w as i,i as x,t as le,N as it,M as re,ai as ut,ag as ct,c as te,ad as dt,be as pt,E as ft,a9 as mt,C as bt,D as vt,aa as ht,ab as gt,F as _t,ax as yt,ay as wt,a6 as xt,ar as be,_ as kt,au as $t}from"./index-W31l-hMM.js";import{l as ve}from"./lodash-TTc0gmdQ.js";import{d as St,e as he,g as Nt}from"./basic-config-DDgsSN6Y.js";import{_ as Ct}from"./DataTable--9asdZH_.js";import{_ as It}from"./FormItemGridItem-D73TxqmL.js";import{_ as Rt}from"./Grid-CIumVYLX.js";import"./Forward-DyDCrUKk.js";const ge=G({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const s=g(null),r=g(e.value),l=g(e.value),c=g("up"),o=g(!1),d=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-current-number--${c.value}-scroll`:null),I=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-old-number--${c.value}-scroll`:null);_e(ne(e,"value"),(f,w)=>{r.value=w,l.value=f,de(V)});function V(){const f=e.newOriginalNumber,w=e.oldOriginalNumber;w===void 0||f===void 0||(f>w?k("up"):w>f&&k("down"))}function k(f){c.value=f,o.value=!1,de(()=>{var w;(w=s.value)===null||w===void 0||w.offsetWidth,o.value=!0})}return()=>{const{clsPrefix:f}=e;return h("span",{ref:s,class:`${f}-base-slot-machine-number`},r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,I.value]},r.value):null,h("span",{class:[`${f}-base-slot-machine-current-number`,d.value]},h("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},l.value)),r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,I.value]},r.value):null)}}}),{cubicBezierEaseOut:W}=je;function Pt({duration:e=".2s"}={}){return[_("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${W},
 max-width ${e} ${W},
 transform ${e} ${W}
