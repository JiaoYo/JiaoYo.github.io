import{_ as Ye}from"./round-plus-Ci7CbhLl.js";import{d as G,j as g,b as B,y as _e,ax as de,aH as ne,aL as h,aD as _,aY as je,aA as C,aZ as Le,aB as $,aC as ye,a_ as we,a$ as Ue,b0 as Fe,aE as We,b1 as pe,aF as xe,aG as ke,b2 as Ge,K as $e,b3 as Se,b4 as Ke,aK as Xe,b5 as He,a5 as Ze,b6 as Je,aM as Qe,b7 as et,b8 as tt,b9 as ee,ba as nt,bb as Z,bc as at,bd as st,be as lt,o as O,e as ae,f as j,a1 as rt,r as ot,g as a,A as H,Y as fe,B as A,$ as se,ao as F,h as P,L as me,w as i,i as x,t as le,N as it,M as re,aj as ut,ah as ct,c as te,ae as dt,bf as pt,E as ft,aa as mt,C as bt,D as vt,ab as ht,ac as gt,F as _t,ay as yt,az as wt,a7 as xt,as as be,_ as kt,av as $t}from"./index-DU0tn_QU.js";import{l as ve}from"./lodash-DWo0GION.js";import{d as St,e as he,g as Nt}from"./basic-config-Dbrrgzgk.js";import{_ as Ct}from"./DataTable-kUpLPqEf.js";import{_ as It}from"./FormItemGridItem-B7QnKLLT.js";import{_ as Rt}from"./Grid-CL01GhEs.js";import"./Forward-oJtYo3di.js";const ge=G({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const s=g(null),r=g(e.value),l=g(e.value),c=g("up"),o=g(!1),d=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-current-number--${c.value}-scroll`:null),I=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-old-number--${c.value}-scroll`:null);_e(ne(e,"value"),(f,w)=>{r.value=w,l.value=f,de(V)});function V(){const f=e.newOriginalNumber,w=e.oldOriginalNumber;w===void 0||f===void 0||(f>w?k("up"):w>f&&k("down"))}function k(f){c.value=f,o.value=!1,de(()=>{var w;(w=s.value)===null||w===void 0||w.offsetWidth,o.value=!0})}return()=>{const{clsPrefix:f}=e;return h("span",{ref:s,class:`${f}-base-slot-machine-number`},r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,I.value]},r.value):null,h("span",{class:[`${f}-base-slot-machine-current-number`,d.value]},h("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},l.value)),r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,I.value]},r.value):null)}}}),{cubicBezierEaseOut:W}=je;function Pt({duration:e=".2s"}={}){return[_("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${W},
 max-width ${e} ${W},
 transform ${e} ${W}
