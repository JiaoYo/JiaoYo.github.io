import{ba as p,bb as e,cy as F,bc as C,bd as B,bf as G,bg as H,d as E,bh as q,bi as L,b as M,by as k,bm as K,dX as N,dp as Q,aQ as n,ct as W,dq as X,dY as Y}from"./index-CM2axccV.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function J(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
