import{aD as p,aA as e,ba as V,aB as C,aC as j,bb as G,bc as H,d as E,aF as K,aG as L,b as D,be as k,aK as W,cW as N,bl as X,aL as n,cs as q,bm as J,cX as Q}from"./index-CXJ7AQei.js";function M(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function U(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
