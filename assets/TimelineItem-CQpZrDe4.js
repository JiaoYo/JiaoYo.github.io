import{cr as O,k as V,dp as W,m as t,aa as d,l as g,ab as l,d as S,p as y,q as $,n as s,ai as E,a9 as H,aj as v,ak as z,C as K,an as M,a as x,ao as p,dq as q,r as L}from"./index-Cljem0dz.js";let b=!1;function D(){if(O&&window.CSS&&!b&&(b=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function A(e){const{textColor3:n,infoColor:o,errorColor:r,successColor:i,warningColor:a,textColor1:c,textColor2:m,railColor:h,fontWeightStrong:f,fontSize:u}=e;return Object.assign(Object.assign({},W),{contentFontSize:u,titleFontWeight:f,circleBorder:`2px solid ${n}`,circleBorderInfo:`2px solid ${o}`,circleBorderError:`2px solid ${r}`,circleBorderSuccess:`2px solid ${i}`,circleBorderWarning:`2px solid ${a}`,iconColor:n,iconColorInfo:o,iconColorError:r,iconColorSuccess:i,iconColorWarning:a,titleTextColor:c,contentTextColor:m,metaTextColor:n,lineColor:h})}const G={common:V,self:A},C=1.25,J=t("timeline",`
 position: relative;
 width: 100%;
 display: flex;
