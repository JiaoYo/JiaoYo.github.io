import{aM as p,aJ as e,bq as F,aK as C,aL as j,cq as q,cr as G,d as E,aO as H,aP as L,b as B,bu as O,aT as K,cs as J,br as N,aU as n,b4 as U,bs as W,ct as Q}from"./index-b-tEOQea.js";function D(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
