...
`,[S("pagination-prefix",`
 ...
 margin: 0;
 `)])])]),zr=Object.assign(Object.assign({},Ue.props),{simple:Boolean,page:Number,defaultPage:{type:Number,default:1},itemCount:Number,pageCount:Number,defaultPageCount:{type:Number,default:1},showSizePicker:Boolean,pageSize:Number,defaultPageSize:Number,pageSizes:{type:Array,default(){return[10]}},showQuickJumper:Boolean,size:{type:String,default:"medium"},disabled:Boolean,pageSlot:{type:Number,default:9},selectProps:Object,prev:Function,next:Function,goto:Function,prefix:Function,suffix:Function,label:Function,displayOrder:{type:Array,default:["pages","size-picker","quick-jumper"]},to:Xn.propTo,showQuickJumpDropdown:{type:Boolean,default:!0},"onUpdate:page":[Function,Array],onUpdatePage:[Function,Array],"onUpdate:pageSize":[Function,Array],onUpdatePageSize:[Function,Array],onPageSizeChange:[Function,Array],onChange:[Function,Array]}),Mr=ae({name:"Pagination",props:zr,setup(e){const{mergedComponentPropsRef:n,mergedClsPrefixRef:t,inlineThemeDisabled:r,mergedRtlRef:o}=We(e),i=Ue("Pagination","-pagination",Pr,Gn,e,t),{localeRef:m}=en("Pagination"),v=V(null),c=V(e.defaultPage),l=V(ln(e)),p=Ye(de(e,"page"),c),b=Ye(de(e,"pageSize"),l),x=C(()=>{const{itemCount:h}=e;if(h!==void 0)return Math.max(1,Math.ceil(h/b.value));const{pageCount:A}=e;return A!==void 0?Math.max(A,1):1}),f=V("");Ze(()=>{e.simple,f.value=String(p.value)});const d=V(!1),u=V(!1),s=V(!1),y=V(!1),R=()=>{e.disabled||(d.value=!0,D())},T=()=>{e.disabled||(d.value=!1,D())},G=()=>{u.value=!0,D()},M=()=>{u.value=!1,D()},E=h=>{W(h)},B=C(()=>Fr(p.value,x.value,e.pageSlot,e.showQuickJumpDropdown));Ze(()=>{B.value.hasFastBackward?B.value.hasFastForward||(d.value=!1,s.value=!1):(u.value=!1,y.value=!1)});const O=C(()=>{const h=m.value.selectionSuffix;return e.pageSizes.map(A=>typeof A=="number"?{label:`${A} / ${h}`,value:A}:A)}),w=C(()=>{var h,A;return((A=(h=n==null?void 0:n.value)===null||h===void 0?void 0:h.Pagination)===null||A===void 0?void 0:A.inputSize)||At(e.size)}),F=C(()=>{var h,A;return((A=(h=n==null?void 0:n.value)===null||h===void 0?void 0:h.Pagination)===null||A===void 0?void 0:A.selectSize)||At(e.size)}),q=C(()=>(p.value-1)*b.value),L=C(()=>{const h=p.value*b.value-1,{itemCount:A}=e;return A!==void 0&&h>A-1?A-1:h}),K=C(()=>{const{itemCount:h}=e;return h!==void 0?h:(e.pageCount||1)*b.value}),j=bt("Pagination",o,t),D=()=>{ht(()=>{var h;const{value:A}=v;A&&(A.classList.add("transition-disabled"),(h=v.value)===null||h===void 0||h.offsetWidth,A.classList.remove("transition-disabled"))})};function W(h){if(h===p.value)return;const{"onUpdate:page":A,onUpdatePage:he,onChange:ue,simple:N}=e;A&&X(A,h),he&&X(he,h),ue&&X(ue,h),c.value=h,N&&(f.value=String(h))}function se(h){if(h===b.value)return;const{"onUpdate:pageSize":A,onUpdatePageSize:he,onPageSizeChange:ue}=e;A&&X(A,h),he&&X(he,h),ue&&X(ue,h),l.value=h,x.value<p.value&&W(x.value)}function oe(){if(e.disabled)return;const h=Math.min(p.value+1,x.value);W(h)}function fe(){if(e.disabled)return;const h=Math.max(p.value-1,1);W(h)}function ee(){if(e.disabled)return;const h=Math.min(B.value.fastForwardTo,x.value);W(h)}function g(){if(e.disabled)return;const h=Math.max(B.value.fastBackwardTo,1);W(h)}function k(h){se(h)}function $(){const h=parseInt(f.value);Number.isNaN(h)||(W(Math.max(1,Math.min(h,x.value))),e.simple||(f.value=""))}function P(){$()}function U(h){if(!e.disabled)switch(h.type){case"page":W(h.label);break;case"fast-backward":g();break;case"fast-forward":ee();break}}function ie(h){f.value=h.replace(/\D+/g,"")}Ze(()=>{p.value,b.value,D()});const le=C(()=>{const{size:h}=e,{self:{buttonBorder:A,buttonBorderHover:he,buttonBorderPressed:ue,buttonIconColor:N,buttonIconColorHover:Y,buttonIconColorPressed:ke,itemTextColor:me,itemTextColorHover:ge,itemTextColorPressed:Ne,itemTextColorActive:je,itemTextColorDisabled:Ce,itemColor:we,itemColorHover:Ae,itemColorPressed:Le,itemColorActive:Ie,itemColorActiveHover:qe,itemColorDisabled:_e,itemBorder:ve,itemBorderHover:Te,itemBorderPressed:Be,itemBorderActive:z,itemBorderDisabled:I,itemBorderRadius:te,jumperTextColor:_,jumperTextColorDisabled:Q,buttonColor:be,buttonColorHover:Z,buttonColorPressed:re,[pe("itemPadding",h)]:ce,[pe("itemMargin",h)]:Re,[pe("inputWidth",h)]:De,[pe("selectWidth",h)]:Oe,[pe("inputMargin",h)]:Ee,[pe("selectMargin",h)]:He,[pe("jumperFontSize",h)]:Se,[pe("prefixMargin",h)]:Xe,[pe("suffixMargin",h)]:ye,[pe("itemSize",h)]:xe,[pe("buttonIconSize",h)]:at,[pe("itemFontSize",h)]:ot,[`${pe("itemMargin",h)}Rtl`]:it,[`${pe("inputMargin",h)}Rtl`]:lt},common:{cubicBezierEaseInOut:dt}}=i.value;return{"--n-prefix-margin":Xe,"--n-suffix-margin":ye,"--n-item-font-size":ot,"--n-select-width":Oe,"--n-select-margin":He,"--n-input-width":De,"--n-input-margin":Ee,"--n-input-margin-rtl":lt,"--n-item-size":xe,"--n-item-text-color":me,"--n-item-text-color-disabled":Ce,"--n-item-text-color-hover":ge,"--n-item-text-color-active":je,"--n-item-text-color-pressed":Ne,"--n-item-color":we,"--n-item-color-hover":Ae,"--n-item-color-disabled":_e,"--n-item-color-active":Ie,"--n-item-color-active-hover":qe,"--n-item-color-pressed":Le,"--n-item-border":ve,"--n-item-border-hover":Te,"--n-item-border-disabled":I,"--n-item-border-active":z,"--n-item-border-pressed":Be,"--n-item-padding":ce,"--n-item-border-radius":te,"--n-bezier":dt,"--n-jumper-font-size":Se,"--n-jumper-text-color":_,"--n-jumper-text-color-disabled":Q,"--n-item-margin":Re,"--n-item-margin-rtl":it,"--n-button-icon-size":at,"--n-button-icon-color":N,"--n-button-icon-color-hover":Y,"--n-button-icon-color-pressed":ke,"--n-button-color-hover":Z,"--n-button-color":be,"--n-button-color-pressed":re,"--n-button-border":A,"--n-button-border-hover":he,"--n-button-border-pressed":ue}}),ne=r?mt("pagination",C(()=>{let h="";const{size:A}=e;return h+=A[0],h}),le,e):void 0;return{rtlEnabled:j,mergedClsPrefix:t,locale:m,selfRef:v,mergedPage:p,pageItems:C(()=>B.value.items),mergedItemCount:K,jumperValue:f,pageSizeOptions:O,mergedPageSize:b,inputSize:w,selectSize:F,mergedTheme:i,mergedPageCount:x,startIndex:q,endIndex:L,showFastForwardMenu:s,showFastBackwardMenu:y,fastForwardActive:d,fastBackwardActive:u,handleMenuSelect:E,handleFastForwardMouseenter:R,handleFastForwardMouseleave:T,handleFastBackwardMouseenter:G,handleFastBackwardMouseleave:M,handleJumperInput:ie,handleBackwardClick:fe,handleForwardClick:oe,handlePageItemClick:U,handleSizePickerChange:k,handleQuickJumperChange:P,cssVars:r?void 0:le,themeClass:ne==null?void 0:ne.themeClass,onRender:ne==null?void 0:ne.onRender}},render(){const{$slots:e,mergedClsPrefix:n,disabled:t,cssVars:r,mergedPage:o,mergedPageCount:i,pageItems:m,showSizePicker:v,showQuickJumper:c,mergedTheme:l,locale:p,inputSize:b,selectSize:x,mergedPageSize:f,pageSizeOptions:d,jumperValue:u,simple:s,prev:y,next:R,prefix:T,suffix:G,label:M,goto:E,handleJumperInput:B,handleSizePickerChange:O,handleBackwardClick:w,handlePageItemClick:F,handleForwardClick:q,handleQuickJumperChange:L,onRender:K}=this;K==null||K();const j=e.prefix||T,D=e.suffix||G,W=y||e.prev,se=R||e.next,oe=M||e.label;return a("div",{ref:"selfRef",class:[`${n}-pagination`,this.themeClass,this.rtlEnabled&&`${n}-pagination--rtl`,t&&`${n}-pagination--disabled`,s&&`${n}-pagination--simple`],style:r},j?a("div",{class:`${n}-pagination-prefix`},j({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount})):null,this.displayOrder.map(fe=>{switch(fe){case"pages":return a(et,null,a("div",{class:[`${n}-pagination-item`,!W&&`${n}-pagination-item--button`,(o<=1||o>i||t)&&`${n}-pagination-item--disabled`],onClick:w},W?W({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount}):a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Tt,null):a(Bt,null)})),s?a(et,null,a("div",{class:`${n}-pagination-quick-jumper`},a(St,{value:u,onUpdateValue:B,size:b,placeholder:"",disabled:t,theme:l.peers.Input,themeOverrides:l.peerOverrides.Input,onChange:L}))," / ",i):m.map((ee,g)=>{let k,$,P;const{type:U}=ee;switch(U){case"page":const le=ee.label;oe?k=oe({type:"page",node:le,active:ee.active}):k=le;break;case"fast-forward":const ne=this.fastForwardActive?a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a($t,null):a(Ot,null)}):a($e,{clsPrefix:n},{default:()=>a(Et,null)});oe?k=oe({type:"fast-forward",node:ne,active:this.fastForwardActive||this.showFastForwardMenu}):k=ne,$=this.handleFastForwardMouseenter,P=this.handleFastForwardMouseleave;break;case"fast-backward":const h=this.fastBackwardActive?a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Ot,null):a($t,null)}):a($e,{clsPrefix:n},{default:()=>a(Et,null)});oe?k=oe({type:"fast-backward",node:h,active:this.fastBackwardActive||this.showFastBackwardMenu}):k=h,$=this.handleFastBackwardMouseenter,P=this.handleFastBackwardMouseleave;break}const ie=a("div",{key:g,class:[`${n}-pagination-item`,ee.active&&`${n}-pagination-item--active`,U!=="page"&&(U==="fast-backward"&&this.showFastBackwardMenu||U==="fast-forward"&&this.showFastForwardMenu)&&`${n}-pagination-item--hover`,t&&`${n}-pagination-item--disabled`,U==="page"&&`${n}-pagination-item--clickable`],onClick:()=>{F(ee)},onMouseenter:$,onMouseleave:P},k);if(U==="page"&&!ee.mayBeFastBackward&&!ee.mayBeFastForward)return ie;{const le=ee.type==="page"?ee.mayBeFastBackward?"fast-backward":"fast-forward":ee.type;return ee.type!=="page"&&!ee.options?ie:a(Sr,{to:this.to,key:le,disabled:t,trigger:"hover",virtualScroll:!0,style:{width:"60px"},theme:l.peers.Popselect,themeOverrides:l.peerOverrides.Popselect,builtinThemeOverrides:{peers:{InternalSelectMenu:{height:"calc(var(--n-option-height) * 4.6)"}}},nodeProps:()=>({style:{justifyContent:"center"}}),show:U==="page"?!1:U==="fast-backward"?this.showFastBackwardMenu:this.showFastForwardMenu,onUpdateShow:ne=>{U!=="page"&&(ne?U==="fast-backward"?this.showFastBackwardMenu=ne:this.showFastForwardMenu=ne:(this.showFastBackwardMenu=!1,this.showFastForwardMenu=!1))},options:ee.type!=="page"&&ee.options?ee.options:[],onUpdateValue:this.handleMenuSelect,scrollable:!0,showCheckmark:!1},{default:()=>ie})}}),a("div",{class:[`${n}-pagination-item`,!se&&`${n}-pagination-item--button`,{[`${n}-pagination-item--disabled`]:o<1||o>=i||t}],onClick:q},se?se({page:o,pageSize:f,pageCount:i,itemCount:this.mergedItemCount,startIndex:this.startIndex,endIndex:this.endIndex}):a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Bt,null):a(Tt,null)})));case"size-picker":return!s&&v?a(qn,Object.assign({consistentMenuWidth:!1,placeholder:"",showCheckmark:!1,to:this.to},this.selectProps,{size:x,options:d,value:f,disabled:t,theme:l.peers.Select,themeOverrides:l.peerOverrides.Select,onUpdateValue:O})):null;case"quick-jumper":return!s&&c?a("div",{class:`${n}-pagination-quick-jumper`},E?E():yt(this.$slots.goto,()=>[p.goto]),a(St,{value:u,onUpdateValue:B,size:b,placeholder:"",disabled:t,theme:l.peers.Input,themeOverrides:l.peerOverrides.Input,onChange:L})):null;default:return null}}),D?a("div",{class:`${n}-pagination-suffix`},D({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount})):null)}}),dn=S("ellipsis",{overflow:"hidden"},[rt("line-clamp",`
 white-space: nowrap;
