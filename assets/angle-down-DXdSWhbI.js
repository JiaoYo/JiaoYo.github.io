import{d as ne,D as w,b as g,X as ee,a2 as H,ba as ae,al as d,bb as v,bc as ta,bd as r,be as na,bf as m,bg as _,bh as oa,bi as ra,bj as ia,bk as Ce,bl as te,bm as Se,bn as la,bo as $e,bp as sa,bq as ze,br as oe,bs as da,m as ca,bt as ua,bu as fa,bv as ue,bw as ha,bx as ma,by as va,bz as ba,bA as pa,bB as ga,bC as xa,bD as wa,bE as fe,bF as ya,bG as ka,bH as Ra,bI as Ca,bJ as Z,bK as J,bL as Q,C as Sa,c as $a,o as za,e as Ba}from"./index-R7qo46Lf.js";const ye=ne({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=w(null),c=w(e.value),u=w(e.value),i=w("up"),l=w(!1),y=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),C=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);ee(ae(e,"value"),(f,b)=>{c.value=b,u.value=f,H(V)});function V(){const f=e.newOriginalNumber,b=e.oldOriginalNumber;b===void 0||f===void 0||(f>b?D("up"):b>f&&D("down"))}function D(f){i.value=f,l.value=!1,H(()=>{var b;(b=o.value)===null||b===void 0||b.offsetWidth,l.value=!0})}return()=>{const{clsPrefix:f}=e;return d("span",{ref:o,class:`${f}-base-slot-machine-number`},c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,C.value]},c.value):null,d("span",{class:[`${f}-base-slot-machine-current-number`,y.value]},d("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,C.value]},c.value):null)}}}),{cubicBezierEaseOut:O}=ta;function Ta({duration:e=".2s"}={}){return[v("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${O},
 max-width ${e} ${O},
 transform ${e} ${O}
