import{bn as p,bo as e,cF as V,bp as C,bq as B,bs as q,bt as G,d as E,bu as H,bv as L,b as M,bL as k,bz as K,dY as N,dq as W,b4 as n,cA as Y,dr as Z,dZ as J}from"./index-ABy-DYGK.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function Q(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
