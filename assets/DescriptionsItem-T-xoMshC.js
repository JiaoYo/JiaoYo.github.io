import{bn as p,bo as e,cG as F,bp as C,bq as j,bs as G,bt as H,d as E,bu as q,bv as L,b as M,bL as k,bz as K,dZ as N,dr as W,b4 as n,cB as Z,ds as J,d_ as Q}from"./index-00pZtPBt.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function U(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
