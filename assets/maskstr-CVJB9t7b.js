import{aU as G,k as L,aV as E,m as r,aa as f,l as u,ab as l,d as y,p as $,q as k,n as s,ai as F,a9 as H,aj as z,ak as x,C as M,an as N,a as C,ao as p,aW as V,r as W,aX as n,aY as q}from"./index-CYM7WsrU.js";let b=!1;function Z(){if(G&&window.CSS&&!b&&(b=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function U(e){const{textColor3:t,infoColor:o,errorColor:a,successColor:i,warningColor:c,textColor1:m,textColor2:d,railColor:g,fontWeightStrong:h,fontSize:v}=e;return Object.assign(Object.assign({},E),{contentFontSize:v,titleFontWeight:h,circleBorder:`2px solid ${t}`,circleBorderInfo:`2px solid ${o}`,circleBorderError:`2px solid ${a}`,circleBorderSuccess:`2px solid ${i}`,circleBorderWarning:`2px solid ${c}`,iconColor:t,iconColorInfo:o,iconColorError:a,iconColorSuccess:i,iconColorWarning:c,titleTextColor:m,contentTextColor:d,metaTextColor:t,lineColor:g})}const K={common:L,self:U},S=1.25,Y=r("timeline",`
 position: relative;
 width: 100%;
 display: flex;
