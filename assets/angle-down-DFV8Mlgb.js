import{d as ne,D as w,a as g,X as ee,ao as _,bl as ae,aH as d,bm as v,bn as ta,bo as r,bp as na,bq as m,br as H,bs as oa,bt as ra,bu as ia,bv as Ce,bw as te,bx as Se,by as la,bz as $e,bA as sa,bB as ze,bC as oe,bD as da,n as ca,bE as ua,bF as fa,bG as ue,bH as ha,bI as ma,bJ as va,bK as ba,bL as pa,bM as ga,bN as xa,bO as wa,bP as fe,bQ as ya,bR as Ra,bS as ka,bT as Ca,bU as Z,bV as J,bW as Q,m as Sa,b as $a,o as za,e as Ba}from"./index-BctxwhPc.js";const ye=ne({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=w(null),c=w(e.value),u=w(e.value),i=w("up"),l=w(!1),y=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),C=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);ee(ae(e,"value"),(f,b)=>{c.value=b,u.value=f,_(V)});function V(){const f=e.newOriginalNumber,b=e.oldOriginalNumber;b===void 0||f===void 0||(f>b?M("up"):b>f&&M("down"))}function M(f){i.value=f,l.value=!1,_(()=>{var b;(b=o.value)===null||b===void 0||b.offsetWidth,l.value=!0})}return()=>{const{clsPrefix:f}=e;return d("span",{ref:o,class:`${f}-base-slot-machine-number`},c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,C.value]},c.value):null,d("span",{class:[`${f}-base-slot-machine-current-number`,y.value]},d("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,C.value]},c.value):null)}}}),{cubicBezierEaseOut:O}=ta;function Ta({duration:e=".2s"}={}){return[v("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${O},
 max-width ${e} ${O},
 transform ${e} ${O}
