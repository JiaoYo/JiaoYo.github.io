import{bb as p,bc as e,cz as F,bd as C,be as B,bg as G,bh as H,d as E,bi as q,bj as L,a as M,bz as j,bn as K,dY as N,dq as W,aR as n,cu as Y,dr as Z,dZ as J}from"./index-vQQ96wkD.js";function D(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function Q(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
