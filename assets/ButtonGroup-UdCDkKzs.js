import{m as a,ad as d,aa as e,l as o,ab as s,d as f,n as p,p as b,dB as g,ag as m,a9 as h,dK as $}from"./index-B_oLz7Qo.js";const t="0!important",u="-1px!important";function i(r){return e(`${r}-type`,[o("& +",[a("button",{},[e(`${r}-type`,[s("border",{borderLeftWidth:t}),s("state-border",{left:u})])])])])}function n(r){return e(`${r}-type`,[o("& +",[a("button",[e(`${r}-type`,[s("border",{borderTopWidth:t}),s("state-border",{top:u})])])])])}const y=a("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
