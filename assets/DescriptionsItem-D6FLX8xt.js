import{aK as p,aH as e,bB as V,aI as C,aJ as O,cx as H,cy as G,d as E,aM as K,aN as L,b as j,bF as k,aR as N,cz as J,bC as W,aS as n,b2 as q,bD as Q,cA as U}from"./index-BcwJAI2q.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
