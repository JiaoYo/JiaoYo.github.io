import{aJ as p,aG as e,bp as F,aH as C,aI as j,cp as G,cq as H,d as E,aL as q,aM as L,b as B,bt as k,aQ as J,cr as K,bq as N,aR as n,b1 as Q,br as W,cs as U}from"./index-EW2EHvBZ.js";function D(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
