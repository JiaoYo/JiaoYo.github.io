import{b0 as We,b1 as qe,b2 as Ge,b3 as M,b4 as n,b5 as b,b6 as _,b7 as he,b8 as Je,b9 as Qe,d as Ze,ba as eo,bb as ge,j as k,bc as oo,b as p,bd as ao,be as to,a6 as fe,ab as Z,a7 as no,bf as ve,bg as ro,bh as ee,aK as f,bi as io,bj as lo,bk as so,bl as co,Y as uo,bm as N,bn as U,bo as O}from"./index-CqzOHcIS.js";const ho=t=>{const i="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:v,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:K,borderRadius:L,fontSize:V,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:V,markFontSize:V,railColor:v,railColorHover:v,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:K,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:L,dotBorder:`2px solid ${v}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})},fo={name:"Slider",common:We,self:ho};function be(t){return window.TouchEvent&&t instanceof window.TouchEvent}function me(){const t=new Map,i=y=>v=>{t.set(y,v)};return Ge(()=>{t.clear()}),[t,i]}const vo=M([n("slider",`
 display: block;
