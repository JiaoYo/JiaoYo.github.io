import{d as ne,E as w,a as g,ac as ee,a8 as H,b2 as ae,a7 as d,b3 as v,b4 as ta,b5 as r,b6 as na,b7 as m,b8 as _,b9 as oa,ba as ra,bb as ia,bc as Ce,bd as te,be as Se,bf as la,bg as $e,bh as sa,bi as ze,bj as oe,bk as da,p as ca,bl as ua,bm as fa,bn as ue,bo as ha,bp as ma,bq as va,br as ba,bs as pa,bt as ga,bu as xa,bv as wa,bw as fe,bx as ya,by as ka,bz as Ra,bA as Ca,bB as G,bC as J,bD as Q,D as Sa,b as $a,o as za,e as Ba}from"./index-NndD7B01.js";const ye=ne({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=w(null),c=w(e.value),u=w(e.value),i=w("up"),l=w(!1),y=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),C=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);ee(ae(e,"value"),(f,b)=>{c.value=b,u.value=f,H(V)});function V(){const f=e.newOriginalNumber,b=e.oldOriginalNumber;b===void 0||f===void 0||(f>b?D("up"):b>f&&D("down"))}function D(f){i.value=f,l.value=!1,H(()=>{var b;(b=o.value)===null||b===void 0||b.offsetWidth,l.value=!0})}return()=>{const{clsPrefix:f}=e;return d("span",{ref:o,class:`${f}-base-slot-machine-number`},c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,C.value]},c.value):null,d("span",{class:[`${f}-base-slot-machine-current-number`,y.value]},d("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,C.value]},c.value):null)}}}),{cubicBezierEaseOut:O}=ta;function Ta({duration:e=".2s"}={}){return[v("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${O},
 max-width ${e} ${O},
 transform ${e} ${O}
 ...
 top: 0;
 bottom: 0;
 `)])])]),Fa=Object.assign(Object.assign({},oe.props),{value:[String,Number],max:Number,dot:Boolean,type:{type:String,default:"default"},show:{type:Boolean,default:!0},showZero:Boolean,processing:Boolean,color:String,offset:Array}),La=ne({name:"Badge",props:Fa,setup(e,{slots:o}){const{mergedClsPrefixRef:c,inlineThemeDisabled:u,mergedRtlRef:i}=ze(e),l=oe("Badge","-badge",Ea,Va,e,c),y=w(!1),C=()=>{y.value=!0},V=()=>{y.value=!1},D=g(()=>e.show&&(e.dot||e.value!==void 0&&!(!e.showZero&&Number(e.value)<=0)||!da(o.value)));ca(()=>{D.value&&(y.value=!0)});const f=ua("Badge",i,c),b=g(()=>{const{type:S,color:B}=e,{common:{cubicBezierEaseInOut:$,cubicBezierEaseOut:k},self:{[fa("color",S)]:E,fontFamily:re,fontSize:j}}=l.value;return{"--n-font-size":j,"--n-font-family":re,"--n-color":B||E,"--n-ripple-color":B||E,"--n-bezier":$,"--n-ripple-bezier":k}}),z=u?ue("badge",g(()=>{let S="";const{type:B,color:$}=e;return B&&(S+=B[0]),$&&(S+=ha($)),S}),b,e):void 0,Y=g(()=>{const{offset:S}=e;if(!S)return;const[B,$]=S,k=typeof B=="number"?`${B}px`:B,E=typeof $=="number"?`${$}px`:$;return{transform:`translate(calc(${f!=null&&f.value?"50%":"-50%"} + ${k}), ${E})`}});return{rtlEnabled:f,mergedClsPrefix:c,appeared:y,showBadge:D,handleAfterEnter:C,handleAfterLeave:V,cssVars:u?void 0:b,themeClass:z==null?void 0:z.themeClass,onRender:z==null?void 0:z.onRender,offsetStyle:Y}},render(){var e;const{mergedClsPrefix:o,onRender:c,themeClass:u,$slots:i}=this;c==null||c();const l=(e=i.default)===null||e===void 0?void 0:e.call(i);return d("div",{class:[`${o}-badge`,this.rtlEnabled&&`${o}-badge--rtl`,u,{[`${o}-badge--dot`]:this.dot,[`${o}-badge--as-is`]:!l}],style:this.cssVars},l,d(Se,{name:"fade-in-scale-up-transition",onAfterEnter:this.handleAfterEnter,onAfterLeave:this.handleAfterLeave},{default:()=>this.showBadge?d("sup",{class:`${o}-badge-sup`,title:la(this.value),style:this.offsetStyle},$e(i.value,()=>[this.dot?null:d(Da,{clsPrefix:o,appeared:this.appeared,max:this.max,value:this.value})]),this.processing?d(sa,{clsPrefix:o}):null):null}))}});function Ia(e){const o="rgba(0, 0, 0, .85)",c="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:u,primaryColor:i,baseColor:l,cardColor:y,modalColor:C,popoverColor:V,borderRadius:D,fontSize:f,opacityDisabled:b}=e;return Object.assign(Object.assign({},ma),{fontSize:f,markFontSize:f,railColor:u,railColorHover:u,fillColor:i,fillColorHover:i,opacityDisabled:b,handleColor:"#FFF",dotColor:y,dotColorModal:C,dotColorPopover:V,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:o,indicatorBoxShadow:c,indicatorTextColor:l,indicatorBorderRadius:D,dotBorder:`2px solid ${u}`,dotBorderActive:`2px solid ${i}`,dotBoxShadow:""})}const Aa={common:Ce,self:Ia},Pa=v([r("slider",`
 display: block;
