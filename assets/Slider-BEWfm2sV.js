import{bj as We,bk as qe,bl as Ge,bm as M,bn as n,bo as b,bp as _,bq as he,br as Je,bs as Qe,d as Ze,bt as eo,bu as ge,m as k,bv as oo,a as p,bw as ao,bx as to,ab as ve,ag as Z,ac as no,by as fe,bz as ro,bA as ee,b4 as v,bB as io,bC as lo,bD as so,bE as co,a3 as uo,bF as N,bG as U,bH as O}from"./index-DVq60TOR.js";const ho=t=>{const i="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:f,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:L,borderRadius:K,fontSize:V,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:V,markFontSize:V,railColor:f,railColorHover:f,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:L,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:K,dotBorder:`2px solid ${f}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})},vo={name:"Slider",common:We,self:ho};function be(t){return window.TouchEvent&&t instanceof window.TouchEvent}function me(){const t=new Map,i=y=>f=>{t.set(y,f)};return Ge(()=>{t.clear()}),[t,i]}const fo=M([n("slider",`
 display: block;
