import{aB as p,ay as e,b8 as F,az as C,aA as O,b9 as G,ba as H,d as E,aD as q,aE as L,b as D,bc as T,aI as J,cU as K,bj as N,aJ as n,cq as U,bk as W,cV as Q}from"./index-DNmEFLor.js";function M(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
