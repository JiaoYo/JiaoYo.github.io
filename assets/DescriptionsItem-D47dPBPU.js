import{b9 as p,ba as e,cw as F,bb as C,bc as B,be as G,bf as H,d as E,bg as W,bh as L,a as M,bx as k,bl as K,dV as N,dm as q,aP as n,cr as J,dn as Q,dW as U}from"./index-7pxtdcYT.js";function D(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
