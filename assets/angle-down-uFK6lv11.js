import{d as ne,D as w,a as g,a1 as ee,ar as H,bd as ae,aq as d,be as v,bf as ta,bg as r,bh as na,bi as m,bj as _,bk as oa,bl as ra,bm as ia,bn as Ce,bo as te,bp as Se,bq as la,br as $e,bs as sa,bt as ze,bu as oe,bv as da,m as ca,bw as ua,bx as fa,by as ue,bz as ha,bA as ma,bB as va,bC as ba,bD as pa,bE as ga,bF as xa,bG as wa,bH as fe,bI as ya,bJ as ka,a2 as Ra,bK as Ca,bL as Z,bM as J,bN as Q,C as Sa,b as $a,o as za,e as Ba}from"./index-C0IJyYiR.js";const ye=ne({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=w(null),c=w(e.value),u=w(e.value),i=w("up"),l=w(!1),y=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),C=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);ee(ae(e,"value"),(f,b)=>{c.value=b,u.value=f,H(V)});function V(){const f=e.newOriginalNumber,b=e.oldOriginalNumber;b===void 0||f===void 0||(f>b?M("up"):b>f&&M("down"))}function M(f){i.value=f,l.value=!1,H(()=>{var b;(b=o.value)===null||b===void 0||b.offsetWidth,l.value=!0})}return()=>{const{clsPrefix:f}=e;return d("span",{ref:o,class:`${f}-base-slot-machine-number`},c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,C.value]},c.value):null,d("span",{class:[`${f}-base-slot-machine-current-number`,y.value]},d("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,C.value]},c.value):null)}}}),{cubicBezierEaseOut:O}=ta;function Ta({duration:e=".2s"}={}){return[v("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${O},
 max-width ${e} ${O},
 transform ${e} ${O}
