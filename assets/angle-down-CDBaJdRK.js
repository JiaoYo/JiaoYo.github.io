import{d as ne,D as w,a as g,X as ee,ao as _,bn as ae,aH as d,bo as v,bp as ta,bq as r,br as na,bs as m,bt as H,bu as oa,bv as ra,bw as ia,bx as Ce,by as te,bz as Se,bA as la,bB as $e,bC as sa,bD as ze,bE as oe,bF as da,n as ca,bG as ua,bH as fa,bI as ue,bJ as ha,bK as ma,bL as va,bM as ba,bN as pa,bO as ga,bP as xa,bQ as wa,bR as fe,bS as ya,bT as Ra,bU as ka,bV as Ca,bW as Z,bX as J,bY as Q,m as Sa,b as $a,o as za,e as Ba}from"./index-DNI9azfB.js";const ye=ne({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=w(null),c=w(e.value),u=w(e.value),i=w("up"),l=w(!1),y=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-current-number--${i.value}-scroll`:null),C=g(()=>l.value?`${e.clsPrefix}-base-slot-machine-old-number--${i.value}-scroll`:null);ee(ae(e,"value"),(f,b)=>{c.value=b,u.value=f,_(V)});function V(){const f=e.newOriginalNumber,b=e.oldOriginalNumber;b===void 0||f===void 0||(f>b?M("up"):b>f&&M("down"))}function M(f){i.value=f,l.value=!1,_(()=>{var b;(b=o.value)===null||b===void 0||b.offsetWidth,l.value=!0})}return()=>{const{clsPrefix:f}=e;return d("span",{ref:o,class:`${f}-base-slot-machine-number`},c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,C.value]},c.value):null,d("span",{class:[`${f}-base-slot-machine-current-number`,y.value]},d("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},u.value)),c.value!==null?d("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,C.value]},c.value):null)}}}),{cubicBezierEaseOut:O}=ta;function Ta({duration:e=".2s"}={}){return[v("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${O},
 max-width ${e} ${O},
 transform ${e} ${O}
 ...
 transform: translateY(0);
 width: .6em;
 `,[m("down-scroll",{animation:"n-base-slot-machine-fade-down-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),m("up-scroll",{animation:"n-base-slot-machine-fade-up-in .2s cubic-bezier(0, 0, .2, 1)",animationIterationCount:1}),H("inner",`
 display: inline-block;
 position: absolute;
 right: 0;
 top: 0;
 ...
 `),m("left",`
 margin-right: 12px;
 `),te()]),va(r("slider",[r("slider-dot","background-color: var(--n-dot-color-modal);")])),ba(r("slider",[r("slider-dot","background-color: var(--n-dot-color-popover);")]))]);function Re(e){return window.TouchEvent&&e instanceof window.TouchEvent}function ke(){const e=new Map,o=c=>u=>{e.set(c,u)};return pa(()=>{e.clear()}),[e,o]}const Oa=0,Ha=Object.assign(Object.assign({},oe.props),{to:fe.propTo,defaultValue:{type:[Number,Array],default:0},marks:Object,disabled:{type:Boolean,default:void 0},formatTooltip:Function,keyboard:{type:Boolean,default:!0},min:{type:Number,default:0},max:{type:Number,default:100},step:{type:[Number,String],default:1},range:Boolean,value:[Number,Array],placement:String,showTooltip:{type:Boolean,default:void 0},tooltip:{type:Boolean,default:!0},vertical:Boolean,reverse:Boolean,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],onDragstart:[Function],onDragend:[Function]}),Ua=ne({name:"Slider",props:Ha,slots:Object,setup(e){const{mergedClsPrefixRef:o,namespaceRef:c,inlineThemeDisabled:u}=ze(e),i=oe("Slider","-slider",Pa,Aa,e,o),l=w(null),[y,C]=ke(),[V,M]=ke(),f=w(new Set),b=ya(e),{mergedDisabledRef:z}=b,Y=g(()=>{const{step:a}=e;if(Number(a)<=0||a==="mark")return 0;const t=a.toString();let n=0;return t.includes(".")&&(n=t.length-t.indexOf(".")-1),n}),S=w(e.defaultValue),B=ae(e,"value"),$=Ra(B,S),R=g(()=>{const{value:a}=$;return(e.range?a:[a]).map(pe)}),E=g(()=>R.value.length>2),re=g(()=>e.placement===void 0?e.vertical?"right":"top":e.placement),j=g(()=>{const{marks:a}=e;return a?Object.keys(a).map(Number.parseFloat):null}),T=w(-1),he=w(-1),F=w(-1),I=w(!1),L=w(!1),ie=g(()=>{const{vertical:a,reverse:t}=e;return a?t?"top":"bottom":t?"right":"left"}),Be=g(()=>{if(E.value)return;const a=R.value,t=U(e.range?Math.min(...a):e.min),n=U(e.range?Math.max(...a):a[0]),{value:s}=ie;return e.vertical?{[s]:`${t}%`,height:`${n-t}%`}:{[s]:`${t}%`,width:`${n-t}%`}}),Te=g(()=>{const a=[],{marks:t}=e;if(t){const n=R.value.slice();n.sort((k,x)=>k-x);const{value:s}=ie,{value:h}=E,{range:p}=e,N=h?()=>!1:k=>p?k>=n[0]&&k<=n[n.length-1]:k<=n[0];for(const k of Object.keys(t)){const x=Number(k);a.push({active:N(x),key:x,label:t[k],style:{[s]:`${U(x)}%`}})}}return a});function Ne(a,t){const n=U(a),{value:s}=ie;return{[s]:`${n}%`,zIndex:t===T.value?1:0}}function me(a){return e.showTooltip||F.value===a||T.value===a&&I.value}function Me(a){return I.value?!(T.value===a&&he.value===a):!0}function De(a){var t;~a&&(T.value=a,(t=y.get(a))===null||t===void 0||t.focus())}function Ve(){V.forEach((a,t)=>{me(t)&&a.syncPosition()})}function ve(a){const{"onUpdate:value":t,onUpdateValue:n}=e,{nTriggerFormInput:s,nTriggerFormChange:h}=b;n&&Z(n,a),t&&Z(t,a),S.value=a,s(),h()}function be(a){const{range:t}=e;if(t){if(Array.isArray(a)){const{value:n}=R;a.join()!==n.join()&&ve(a)}}else Array.isArray(a)||R.value[0]!==a&&ve(a)}function le(a,t){if(e.range){const n=R.value.slice();n.splice(t,1,a),be(n)}else be(a)}function se(a,t,n){const s=n!==void 0;n||(n=a-t>0?1:-1);const h=j.value||[],{step:p}=e;if(p==="mark"){const x=X(a,h.concat(t),s?n:void 0);return x?x.value:t}if(p<=0)return t;const{value:N}=Y;let k;if(s){const x=Number((t/p).toFixed(N)),D=Math.floor(x),de=x>D?D:D-1,ce=x<D?D:D+1;k=X(t,[Number((de*p).toFixed(N)),Number((ce*p).toFixed(N)),...h],n)}else{const x=Fe(a);k=X(a,[...h,x])}return k?pe(k.value):t}function pe(a){return Math.min(e.max,Math.max(e.min,a))}function U(a){const{max:t,min:n}=e;return(a-n)/(t-n)*100}function Ee(a){const{max:t,min:n}=e;return n+(t-n)*a}function Fe(a){const{step:t,min:n}=e;if(Number(t)<=0||t==="mark")return a;const s=Math.round((a-n)/t)*t+n;return Number(s.toFixed(Y.value))}function X(a,t=j.value,n){if(!(t!=null&&t.length))return null;let s=null,h=-1;for(;++h<t.length;){const p=t[h]-a,N=Math.abs(p);(n===void 0||p*n>0)&&(s===null||N<s.distance)&&(s={index:h,distance:N,value:t[h]})}return s}function ge(a){const t=l.value;if(!t)return;const n=Re(a)?a.touches[0]:a,s=t.getBoundingClientRect();let h;return e.vertical?h=(s.bottom-n.clientY)/s.height:h=(n.clientX-s.left)/s.width,e.reverse&&(h=1-h),Ee(h)}function Ie(a){if(z.value||!e.keyboard)return;const{vertical:t,reverse:n}=e;switch(a.key){case"ArrowUp":a.preventDefault(),W(t&&n?-1:1);break;case"ArrowRight":a.preventDefault(),W(!t&&n?-1:1);break;case"ArrowDown":a.preventDefault(),W(t&&n?1:-1);break;case"ArrowLeft":a.preventDefault(),W(!t&&n?1:-1);break}}function W(a){const t=T.value;if(t===-1)return;const{step:n}=e,s=R.value[t],h=Number(n)<=0||n==="mark"?s:s+n*a;le(se(h,s,a>0?1:-1),t)}function Ae(a){var t,n;if(z.value||!Re(a)&&a.button!==Oa)return;const s=ge(a);if(s===void 0)return;const h=R.value.slice(),p=e.range?(n=(t=X(s,h))===null||t===void 0?void 0:t.index)!==null&&n!==void 0?n:-1:0;p!==-1&&(a.preventDefault(),De(p),Pe(),le(se(s,R.value[p]),p))}function Pe(){I.value||(I.value=!0,e.onDragstart&&Z(e.onDragstart),J("touchend",document,G),J("mouseup",document,G),J("touchmove",document,q),J("mousemove",document,q))}function K(){I.value&&(I.value=!1,e.onDragend&&Z(e.onDragend),Q("touchend",document,G),Q("mouseup",document,G),Q("touchmove",document,q),Q("mousemove",document,q))}function q(a){const{value:t}=T;if(!I.value||t===-1){K();return}const n=ge(a);n!==void 0&&le(se(n,R.value[t]),t)}function G(){K()}function Oe(a){T.value=a,z.value||(F.value=a)}function He(a){T.value===a&&(T.value=-1,K()),F.value===a&&(F.value=-1)}function _e(a){F.value=a}function Ye(a){F.value===a&&(F.value=-1)}ee(T,(a,t)=>void _(()=>he.value=t)),ee($,()=>{if(e.marks){if(L.value)return;L.value=!0,_(()=>{L.value=!1})}_(Ve)}),ka(()=>{K()});const xe=g(()=>{const{self:{markFontSize:a,railColor:t,railColorHover:n,fillColor:s,fillColorHover:h,handleColor:p,opacityDisabled:N,dotColor:k,dotColorModal:x,handleBoxShadow:D,handleBoxShadowHover:de,handleBoxShadowActive:ce,handleBoxShadowFocus:je,dotBorder:Le,dotBoxShadow:Ue,railHeight:Xe,railWidthVertical:We,handleSize:Ke,dotHeight:qe,dotWidth:Ge,dotBorderRadius:Ze,fontSize:Je,dotBorderActive:Qe,dotColorPopover:ea},common:{cubicBezierEaseInOut:aa}}=i.value;return{"--n-bezier":aa,"--n-dot-border":Le,"--n-dot-border-active":Qe,"--n-dot-border-radius":Ze,"--n-dot-box-shadow":Ue,"--n-dot-color":k,"--n-dot-color-modal":x,"--n-dot-color-popover":ea,"--n-dot-height":qe,"--n-dot-width":Ge,"--n-fill-color":s,"--n-fill-color-hover":h,"--n-font-size":Je,"--n-handle-box-shadow":D,"--n-handle-box-shadow-active":ce,"--n-handle-box-shadow-focus":je,"--n-handle-box-shadow-hover":de,"--n-handle-color":p,"--n-handle-size":Ke,"--n-opacity-disabled":N,"--n-rail-color":t,"--n-rail-color-hover":n,"--n-rail-height":Xe,"--n-rail-width-vertical":We,"--n-mark-font-size":a}}),A=u?ue("slider",void 0,xe,e):void 0,we=g(()=>{const{self:{fontSize:a,indicatorColor:t,indicatorBoxShadow:n,indicatorTextColor:s,indicatorBorderRadius:h}}=i.value;return{"--n-font-size":a,"--n-indicator-border-radius":h,"--n-indicator-box-shadow":n,"--n-indicator-color":t,"--n-indicator-text-color":s}}),P=u?ue("slider-indicator",void 0,we,e):void 0;return{mergedClsPrefix:o,namespace:c,uncontrolledValue:S,mergedValue:$,mergedDisabled:z,mergedPlacement:re,isMounted:Ca(),adjustedTo:fe(e),dotTransitionDisabled:L,markInfos:Te,isShowTooltip:me,shouldKeepTooltipTransition:Me,handleRailRef:l,setHandleRefs:C,setFollowerRefs:M,fillStyle:Be,getHandleStyle:Ne,activeIndex:T,arrifiedValues:R,followerEnabledIndexSet:f,handleRailMouseDown:Ae,handleHandleFocus:Oe,handleHandleBlur:He,handleHandleMouseEnter:_e,handleHandleMouseLeave:Ye,handleRailKeyDown:Ie,indicatorCssVars:u?void 0:we,indicatorThemeClass:P==null?void 0:P.themeClass,indicatorOnRender:P==null?void 0:P.onRender,cssVars:u?void 0:xe,themeClass:A==null?void 0:A.themeClass,onRender:A==null?void 0:A.onRender}},render(){var e;const{mergedClsPrefix:o,themeClass:c,formatTooltip:u}=this;return(e=this.onRender)===null||e===void 0||e.call(this),d("div",{class:[`${o}-slider`,c,{[`${o}-slider--disabled`]:this.mergedDisabled,[`${o}-slider--active`]:this.activeIndex!==-1,[`${o}-slider--with-mark`]:this.marks,[`${o}-slider--vertical`]:this.vertical,[`${o}-slider--reverse`]:this.reverse}],style:this.cssVars,onKeydown:this.handleRailKeyDown,onMousedown:this.handleRailMouseDown,onTouchstart:this.handleRailMouseDown},d("div",{class:`${o}-slider-rail`},d("div",{class:`${o}-slider-rail__fill`,style:this.fillStyle}),this.marks?d("div",{class:[`${o}-slider-dots`,this.dotTransitionDisabled&&`${o}-slider-dots--transition-disabled`]},this.markInfos.map(i=>d("div",{key:i.key,class:[`${o}-slider-dot`,{[`${o}-slider-dot--active`]:i.active}],style:i.style}))):null,d("div",{ref:"handleRailRef",class:`${o}-slider-handles`},this.arrifiedValues.map((i,l)=>{const y=this.isShowTooltip(l);return d(ga,null,{default:()=>[d(xa,null,{default:()=>d("div",{ref:this.setHandleRefs(l),class:`${o}-slider-handle-wrapper`,tabindex:this.mergedDisabled?-1:0,role:"slider","aria-valuenow":i,"aria-valuemin":this.min,"aria-valuemax":this.max,"aria-orientation":this.vertical?"vertical":"horizontal","aria-disabled":this.disabled,style:this.getHandleStyle(i,l),onFocus:()=>{this.handleHandleFocus(l)},onBlur:()=>{this.handleHandleBlur(l)},onMouseenter:()=>{this.handleHandleMouseEnter(l)},onMouseleave:()=>{this.handleHandleMouseLeave(l)}},$e(this.$slots.thumb,()=>[d("div",{class:`${o}-slider-handle`})]))}),this.tooltip&&d(wa,{ref:this.setFollowerRefs(l),show:y,to:this.adjustedTo,enabled:this.showTooltip&&!this.range||this.followerEnabledIndexSet.has(l),teleportDisabled:this.adjustedTo===fe.tdkey,placement:this.mergedPlacement,containerClass:this.namespace},{default:()=>d(Se,{name:"fade-in-scale-up-transition",appear:this.isMounted,css:this.shouldKeepTooltipTransition(l),onEnter:()=>{this.followerEnabledIndexSet.add(l)},onAfterLeave:()=>{this.followerEnabledIndexSet.delete(l)}},{default:()=>{var C;return y?((C=this.indicatorOnRender)===null||C===void 0||C.call(this),d("div",{class:[`${o}-slider-handle-indicator`,this.indicatorThemeClass,`${o}-slider-handle-indicator--${this.mergedPlacement}`],style:this.indicatorCssVars},typeof u=="function"?u(i):i)):null}})})]})})),this.marks?d("div",{class:`${o}-slider-marks`},this.markInfos.map(i=>d("div",{key:i.key,class:`${o}-slider-mark`,style:i.style},typeof i.label=="function"?i.label():i.label))):null))}}),_a={class:"inline-block",viewBox:"0 0 24 24",width:"1em",height:"1em"};function Ya(e,o){return za(),$a("svg",_a,o[0]||(o[0]=[Ba("path",{fill:"currentColor",d:"M17 9.17a1 1 0 0 0-1.41 0L12 12.71L8.46 9.17a1 1 0 0 0-1.41 0a1 1 0 0 0 0 1.42l4.24 4.24a1 1 0 0 0 1.42 0L17 10.59a1 1 0 0 0 0-1.42"},null,-1)]))}const Xa=Sa({name:"uil-angle-down",render:Ya});export{La as N,Ua as _,Xa as a};
