import{b4 as We,b5 as qe,b6 as Ge,b7 as M,b8 as n,b9 as b,ba as N,bb as he,bc as Je,bd as Qe,d as Ze,be as eo,bf as ge,j as k,bg as oo,b as w,bh as ao,bi as to,a6 as fe,ab as Z,a7 as no,bj as ve,bk as ro,bl as ee,aN as f,bm as io,bn as lo,bo as so,bp as co,Y as uo,bq as _,br as U,bs as O}from"./index-mAjjolp3.js";const ho=t=>{const i="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:v,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:L,borderRadius:Y,fontSize:V,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:V,markFontSize:V,railColor:v,railColorHover:v,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:L,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:Y,dotBorder:`2px solid ${v}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})},fo={name:"Slider",common:We,self:ho};function be(t){return window.TouchEvent&&t instanceof window.TouchEvent}function me(){const t=new Map,i=y=>v=>{t.set(y,v)};return Ge(()=>{t.clear()}),[t,i]}const vo=M([n("slider",`
 display: block;
