import{_ as je}from"./round-plus-DF4zpV2C.js";import{d as G,j as g,b as B,y as _e,ay as de,aI as ne,aM as h,aE as _,aZ as Ye,aB as C,a_ as Le,aC as $,aD as ye,a$ as we,b0 as Ue,b1 as Fe,aF as We,b2 as pe,aG as xe,aH as ke,b3 as Ge,K as $e,b4 as Se,b5 as Ke,aL as Xe,b6 as He,a5 as Ze,b7 as Je,aN as Qe,b8 as et,b9 as tt,ba as ee,bb as nt,bc as Z,bd as at,be as st,bf as lt,o as O,e as ae,f as Y,a1 as rt,r as ot,g as a,A as H,Y as fe,B as A,$ as se,ao as F,h as P,L as me,w as i,i as x,t as le,N as it,M as re,aj as ut,ah as ct,c as te,ae as dt,bg as pt,E as ft,aa as mt,C as bt,D as vt,ab as ht,ac as gt,F as _t,az as yt,aA as wt,a7 as xt,at as be,_ as kt,aw as $t}from"./index-hw7QOW1T.js";import{l as ve}from"./lodash-DnDjgFEo.js";import{d as St,e as he,g as Nt}from"./basic-config-DoQw_5LH.js";import{_ as Ct}from"./DataTable-qeqEjtEf.js";import{_ as It}from"./FormItemGridItem-BJtyHf3C.js";import{_ as Rt}from"./Grid-Cw6tbggG.js";import"./Forward-iJK0D6Xc.js";const ge=G({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const s=g(null),r=g(e.value),l=g(e.value),c=g("up"),o=g(!1),d=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-current-number--${c.value}-scroll`:null),I=B(()=>o.value?`${e.clsPrefix}-base-slot-machine-old-number--${c.value}-scroll`:null);_e(ne(e,"value"),(f,w)=>{r.value=w,l.value=f,de(V)});function V(){const f=e.newOriginalNumber,w=e.oldOriginalNumber;w===void 0||f===void 0||(f>w?k("up"):w>f&&k("down"))}function k(f){c.value=f,o.value=!1,de(()=>{var w;(w=s.value)===null||w===void 0||w.offsetWidth,o.value=!0})}return()=>{const{clsPrefix:f}=e;return h("span",{ref:s,class:`${f}-base-slot-machine-number`},r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--top`,I.value]},r.value):null,h("span",{class:[`${f}-base-slot-machine-current-number`,d.value]},h("span",{ref:"numberWrapper",class:[`${f}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${f}-base-slot-machine-current-number__inner--not-number`]},l.value)),r.value!==null?h("span",{class:[`${f}-base-slot-machine-old-number ${f}-base-slot-machine-old-number--bottom`,I.value]},r.value):null)}}}),{cubicBezierEaseOut:W}=Ye;function Pt({duration:e=".2s"}={}){return[_("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${W},
 max-width ${e} ${W},
 transform ${e} ${W}
