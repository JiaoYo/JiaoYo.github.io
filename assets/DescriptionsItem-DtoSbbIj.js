import{aE as p,aB as e,bt as F,aC as x,aD as O,bu as G,bv as H,d as E,aG as K,aH as L,b as j,b5 as T,aL as N,cQ as Q,bB as W,aM as n,b9 as q,bC as J,cR as U}from"./index-hw7QOW1T.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const V="DESCRIPTION_ITEM_FLAG";function X(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[V]:!1}const Y=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),Z=Object.assign(Object.assign({},L.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:{type:String,default:"medium"},bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),te=E({name:"Descriptions",props:Z,setup(r){const{mergedClsPrefixRef:b,inlineThemeDisabled:a}=K(r),i=L("Descriptions","-descriptions",Y,U,r,b),l=j(()=>{const{size:d,bordered:h}=r,{common:{cubicBezierEaseInOut:g},self:{titleTextColor:S,thColor:P,thColorModal:t,thColorPopover:z,thTextColor:v,thFontWeight:$,tdTextColor:R,tdColor:k,tdColorModal:_,tdColorPopover:o,borderColor:f,borderColorModal:A,borderColorPopover:c,borderRadius:m,lineHeight:y,[T("fontSize",d)]:w,[T(h?"thPaddingBordered":"thPadding",d)]:u,[T(h?"tdPaddingBordered":"tdPadding",d)]:C}}=i.value;return{"--n-title-text-color":S,"--n-th-padding":u,"--n-td-padding":C,"--n-font-size":w,"--n-bezier":g,"--n-th-font-weight":$,"--n-line-height":y,"--n-th-text-color":v,"--n-td-text-color":R,"--n-th-color":P,"--n-th-color-modal":t,"--n-th-color-popover":z,"--n-td-color":k,"--n-td-color-modal":_,"--n-td-color-popover":o,"--n-border-radius":m,"--n-border-color":f,"--n-border-color-modal":A,"--n-border-color-popover":c}}),s=a?N("descriptions",j(()=>{let d="";const{size:h,bordered:g}=r;return g&&(d+="a"),d+=h[0],d}),l,r):void 0;return{mergedClsPrefix:b,cssVars:a?void 0:l,themeClass:s==null?void 0:s.themeClass,onRender:s==null?void 0:s.onRender,compitableColumn:Q(r,["columns","column"]),inlineThemeDisabled:a}},render(){const r=this.$slots.default,b=r?W(r()):[];b.length;const{contentClass:a,labelClass:i,compitableColumn:l,labelPlacement:s,labelAlign:d,size:h,bordered:g,title:S,cssVars:P,mergedClsPrefix:t,separator:z,onRender:v}=this;v==null||v();const $=b.filter(o=>X(o)),R={span:0,row:[],secondRow:[],rows:[]},_=$.reduce((o,f,A)=>{const c=f.props||{},m=$.length-1===A,y=["label"in c?c.label:D(f,"label")],w=[D(f)],u=c.span||1,C=o.span;o.span+=u;const I=c.labelStyle||c["label-style"]||this.labelStyle,B=c.contentStyle||c["content-style"]||this.contentStyle;if(s==="left")g?o.row.push(n("th",{class:[`${t}-descriptions-table-header`,i],colspan:1,style:I},y),n("td",{class:[`${t}-descriptions-table-content`,a],colspan:m?(l-C)*2+1:u*2-1,style:B},w)):o.row.push(n("td",{class:`${t}-descriptions-table-content`,colspan:m?(l-C)*2:u*2},n("span",{class:[`${t}-descriptions-table-content__label`,i],style:I},[...y,z&&n("span",{class:`${t}-descriptions-separator`},z)]),n("span",{class:[`${t}-descriptions-table-content__content`,a],style:B},w)));else{const M=m?(l-C)*2:u*2;o.row.push(n("th",{class:[`${t}-descriptions-table-header`,i],colspan:M,style:I},y)),o.secondRow.push(n("td",{class:[`${t}-descriptions-table-content`,a],colspan:M,style:B},w))}return(o.span>=l||m)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),s!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},R).rows.map(o=>n("tr",{class:`${t}-descriptions-table-row`},o));return n("div",{style:P,class:[`${t}-descriptions`,this.themeClass,`${t}-descriptions--${s}-label-placement`,`${t}-descriptions--${d}-label-align`,`${t}-descriptions--${h}-size`,g&&`${t}-descriptions--bordered`]},S||this.$slots.header?n("div",{class:`${t}-descriptions-header`},S||J(this,"header")):null,n("div",{class:`${t}-descriptions-table-wrapper`},n("table",{class:`${t}-descriptions-table`},n("tbody",null,s==="top"&&n("tr",{class:`${t}-descriptions-table-row`,style:{visibility:"collapse"}},q(l*2,n("td",null))),_))))}}),ee={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},re=E({name:"DescriptionsItem",[V]:!0,props:ee,render(){return null}});export{re as _,te as a};
