...
`,[S("pagination-prefix",`
 ...
 `)]),rt("disabled",[H("hover",Lt,Nt),J("&:hover",Lt,Nt),J("&:active",`
 ...
 margin: 0;
 `)])])]),zr=Object.assign(Object.assign({},Ue.props),{simple:Boolean,page:Number,defaultPage:{type:Number,default:1},itemCount:Number,pageCount:Number,defaultPageCount:{type:Number,default:1},showSizePicker:Boolean,pageSize:Number,defaultPageSize:Number,pageSizes:{type:Array,default(){return[10]}},showQuickJumper:Boolean,size:{type:String,default:"medium"},disabled:Boolean,pageSlot:{type:Number,default:9},selectProps:Object,prev:Function,next:Function,goto:Function,prefix:Function,suffix:Function,label:Function,displayOrder:{type:Array,default:["pages","size-picker","quick-jumper"]},to:Xn.propTo,showQuickJumpDropdown:{type:Boolean,default:!0},"onUpdate:page":[Function,Array],onUpdatePage:[Function,Array],"onUpdate:pageSize":[Function,Array],onUpdatePageSize:[Function,Array],onPageSizeChange:[Function,Array],onChange:[Function,Array]}),Mr=ae({name:"Pagination",props:zr,setup(e){const{mergedComponentPropsRef:n,mergedClsPrefixRef:t,inlineThemeDisabled:r,mergedRtlRef:o}=We(e),i=Ue("Pagination","-pagination",Pr,Gn,e,t),{localeRef:m}=en("Pagination"),v=V(null),c=V(e.defaultPage),l=V(ln(e)),g=Ye(se(e,"page"),c),b=Ye(se(e,"pageSize"),l),x=C(()=>{const{itemCount:h}=e;if(h!==void 0)return Math.max(1,Math.ceil(h/b.value));const{pageCount:A}=e;return A!==void 0?Math.max(A,1):1}),f=V("");Qe(()=>{e.simple,f.value=String(g.value)});const s=V(!1),u=V(!1),d=V(!1),y=V(!1),R=()=>{e.disabled||(s.value=!0,D())},T=()=>{e.disabled||(s.value=!1,D())},G=()=>{u.value=!0,D()},M=()=>{u.value=!1,D()},E=h=>{W(h)},O=C(()=>Fr(g.value,x.value,e.pageSlot,e.showQuickJumpDropdown));Qe(()=>{O.value.hasFastBackward?O.value.hasFastForward||(s.value=!1,d.value=!1):(u.value=!1,y.value=!1)});const B=C(()=>{const h=m.value.selectionSuffix;return e.pageSizes.map(A=>typeof A=="number"?{label:`${A} / ${h}`,value:A}:A)}),w=C(()=>{var h,A;return((A=(h=n==null?void 0:n.value)===null||h===void 0?void 0:h.Pagination)===null||A===void 0?void 0:A.inputSize)||At(e.size)}),F=C(()=>{var h,A;return((A=(h=n==null?void 0:n.value)===null||h===void 0?void 0:h.Pagination)===null||A===void 0?void 0:A.selectSize)||At(e.size)}),q=C(()=>(g.value-1)*b.value),K=C(()=>{const h=g.value*b.value-1,{itemCount:A}=e;return A!==void 0&&h>A-1?A-1:h}),L=C(()=>{const{itemCount:h}=e;return h!==void 0?h:(e.pageCount||1)*b.value}),I=bt("Pagination",o,t),D=()=>{ht(()=>{var h;const{value:A}=v;A&&(A.classList.add("transition-disabled"),(h=v.value)===null||h===void 0||h.offsetWidth,A.classList.remove("transition-disabled"))})};function W(h){if(h===g.value)return;const{"onUpdate:page":A,onUpdatePage:he,onChange:ue,simple:N}=e;A&&X(A,h),he&&X(he,h),ue&&X(ue,h),c.value=h,N&&(f.value=String(h))}function de(h){if(h===b.value)return;const{"onUpdate:pageSize":A,onUpdatePageSize:he,onPageSizeChange:ue}=e;A&&X(A,h),he&&X(he,h),ue&&X(ue,h),l.value=h,x.value<g.value&&W(x.value)}function oe(){if(e.disabled)return;const h=Math.min(g.value+1,x.value);W(h)}function fe(){if(e.disabled)return;const h=Math.max(g.value-1,1);W(h)}function ee(){if(e.disabled)return;const h=Math.min(O.value.fastForwardTo,x.value);W(h)}function p(){if(e.disabled)return;const h=Math.max(O.value.fastBackwardTo,1);W(h)}function k(h){de(h)}function $(){const h=parseInt(f.value);Number.isNaN(h)||(W(Math.max(1,Math.min(h,x.value))),e.simple||(f.value=""))}function P(){$()}function U(h){if(!e.disabled)switch(h.type){case"page":W(h.label);break;case"fast-backward":p();break;case"fast-forward":ee();break}}function ie(h){f.value=h.replace(/\D+/g,"")}Qe(()=>{g.value,b.value,D()});const le=C(()=>{const{size:h}=e,{self:{buttonBorder:A,buttonBorderHover:he,buttonBorderPressed:ue,buttonIconColor:N,buttonIconColorHover:Y,buttonIconColorPressed:ke,itemTextColor:me,itemTextColorHover:pe,itemTextColorPressed:Ne,itemTextColorActive:Ie,itemTextColorDisabled:Ce,itemColor:we,itemColorHover:Ae,itemColorPressed:Ke,itemColorActive:je,itemColorActiveHover:qe,itemColorDisabled:_e,itemBorder:ve,itemBorderHover:Te,itemBorderPressed:Oe,itemBorderActive:z,itemBorderDisabled:j,itemBorderRadius:te,jumperTextColor:_,jumperTextColorDisabled:Z,buttonColor:be,buttonColorHover:Q,buttonColorPressed:re,[ge("itemPadding",h)]:ce,[ge("itemMargin",h)]:Re,[ge("inputWidth",h)]:De,[ge("selectWidth",h)]:Be,[ge("inputMargin",h)]:Ee,[ge("selectMargin",h)]:He,[ge("jumperFontSize",h)]:Se,[ge("prefixMargin",h)]:Xe,[ge("suffixMargin",h)]:ye,[ge("itemSize",h)]:xe,[ge("buttonIconSize",h)]:at,[ge("itemFontSize",h)]:ot,[`${ge("itemMargin",h)}Rtl`]:it,[`${ge("inputMargin",h)}Rtl`]:lt},common:{cubicBezierEaseInOut:st}}=i.value;return{"--n-prefix-margin":Xe,"--n-suffix-margin":ye,"--n-item-font-size":ot,"--n-select-width":Be,"--n-select-margin":He,"--n-input-width":De,"--n-input-margin":Ee,"--n-input-margin-rtl":lt,"--n-item-size":xe,"--n-item-text-color":me,"--n-item-text-color-disabled":Ce,"--n-item-text-color-hover":pe,"--n-item-text-color-active":Ie,"--n-item-text-color-pressed":Ne,"--n-item-color":we,"--n-item-color-hover":Ae,"--n-item-color-disabled":_e,"--n-item-color-active":je,"--n-item-color-active-hover":qe,"--n-item-color-pressed":Ke,"--n-item-border":ve,"--n-item-border-hover":Te,"--n-item-border-disabled":j,"--n-item-border-active":z,"--n-item-border-pressed":Oe,"--n-item-padding":ce,"--n-item-border-radius":te,"--n-bezier":st,"--n-jumper-font-size":Se,"--n-jumper-text-color":_,"--n-jumper-text-color-disabled":Z,"--n-item-margin":Re,"--n-item-margin-rtl":it,"--n-button-icon-size":at,"--n-button-icon-color":N,"--n-button-icon-color-hover":Y,"--n-button-icon-color-pressed":ke,"--n-button-color-hover":Q,"--n-button-color":be,"--n-button-color-pressed":re,"--n-button-border":A,"--n-button-border-hover":he,"--n-button-border-pressed":ue}}),ne=r?mt("pagination",C(()=>{let h="";const{size:A}=e;return h+=A[0],h}),le,e):void 0;return{rtlEnabled:I,mergedClsPrefix:t,locale:m,selfRef:v,mergedPage:g,pageItems:C(()=>O.value.items),mergedItemCount:L,jumperValue:f,pageSizeOptions:B,mergedPageSize:b,inputSize:w,selectSize:F,mergedTheme:i,mergedPageCount:x,startIndex:q,endIndex:K,showFastForwardMenu:d,showFastBackwardMenu:y,fastForwardActive:s,fastBackwardActive:u,handleMenuSelect:E,handleFastForwardMouseenter:R,handleFastForwardMouseleave:T,handleFastBackwardMouseenter:G,handleFastBackwardMouseleave:M,handleJumperInput:ie,handleBackwardClick:fe,handleForwardClick:oe,handlePageItemClick:U,handleSizePickerChange:k,handleQuickJumperChange:P,cssVars:r?void 0:le,themeClass:ne==null?void 0:ne.themeClass,onRender:ne==null?void 0:ne.onRender}},render(){const{$slots:e,mergedClsPrefix:n,disabled:t,cssVars:r,mergedPage:o,mergedPageCount:i,pageItems:m,showSizePicker:v,showQuickJumper:c,mergedTheme:l,locale:g,inputSize:b,selectSize:x,mergedPageSize:f,pageSizeOptions:s,jumperValue:u,simple:d,prev:y,next:R,prefix:T,suffix:G,label:M,goto:E,handleJumperInput:O,handleSizePickerChange:B,handleBackwardClick:w,handlePageItemClick:F,handleForwardClick:q,handleQuickJumperChange:K,onRender:L}=this;L==null||L();const I=e.prefix||T,D=e.suffix||G,W=y||e.prev,de=R||e.next,oe=M||e.label;return a("div",{ref:"selfRef",class:[`${n}-pagination`,this.themeClass,this.rtlEnabled&&`${n}-pagination--rtl`,t&&`${n}-pagination--disabled`,d&&`${n}-pagination--simple`],style:r},I?a("div",{class:`${n}-pagination-prefix`},I({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount})):null,this.displayOrder.map(fe=>{switch(fe){case"pages":return a(et,null,a("div",{class:[`${n}-pagination-item`,!W&&`${n}-pagination-item--button`,(o<=1||o>i||t)&&`${n}-pagination-item--disabled`],onClick:w},W?W({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount}):a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Tt,null):a(Ot,null)})),d?a(et,null,a("div",{class:`${n}-pagination-quick-jumper`},a(St,{value:u,onUpdateValue:O,size:b,placeholder:"",disabled:t,theme:l.peers.Input,themeOverrides:l.peerOverrides.Input,onChange:K}))," / ",i):m.map((ee,p)=>{let k,$,P;const{type:U}=ee;switch(U){case"page":const le=ee.label;oe?k=oe({type:"page",node:le,active:ee.active}):k=le;break;case"fast-forward":const ne=this.fastForwardActive?a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a($t,null):a(Bt,null)}):a($e,{clsPrefix:n},{default:()=>a(Et,null)});oe?k=oe({type:"fast-forward",node:ne,active:this.fastForwardActive||this.showFastForwardMenu}):k=ne,$=this.handleFastForwardMouseenter,P=this.handleFastForwardMouseleave;break;case"fast-backward":const h=this.fastBackwardActive?a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Bt,null):a($t,null)}):a($e,{clsPrefix:n},{default:()=>a(Et,null)});oe?k=oe({type:"fast-backward",node:h,active:this.fastBackwardActive||this.showFastBackwardMenu}):k=h,$=this.handleFastBackwardMouseenter,P=this.handleFastBackwardMouseleave;break}const ie=a("div",{key:p,class:[`${n}-pagination-item`,ee.active&&`${n}-pagination-item--active`,U!=="page"&&(U==="fast-backward"&&this.showFastBackwardMenu||U==="fast-forward"&&this.showFastForwardMenu)&&`${n}-pagination-item--hover`,t&&`${n}-pagination-item--disabled`,U==="page"&&`${n}-pagination-item--clickable`],onClick:()=>{F(ee)},onMouseenter:$,onMouseleave:P},k);if(U==="page"&&!ee.mayBeFastBackward&&!ee.mayBeFastForward)return ie;{const le=ee.type==="page"?ee.mayBeFastBackward?"fast-backward":"fast-forward":ee.type;return ee.type!=="page"&&!ee.options?ie:a(Sr,{to:this.to,key:le,disabled:t,trigger:"hover",virtualScroll:!0,style:{width:"60px"},theme:l.peers.Popselect,themeOverrides:l.peerOverrides.Popselect,builtinThemeOverrides:{peers:{InternalSelectMenu:{height:"calc(var(--n-option-height) * 4.6)"}}},nodeProps:()=>({style:{justifyContent:"center"}}),show:U==="page"?!1:U==="fast-backward"?this.showFastBackwardMenu:this.showFastForwardMenu,onUpdateShow:ne=>{U!=="page"&&(ne?U==="fast-backward"?this.showFastBackwardMenu=ne:this.showFastForwardMenu=ne:(this.showFastBackwardMenu=!1,this.showFastForwardMenu=!1))},options:ee.type!=="page"&&ee.options?ee.options:[],onUpdateValue:this.handleMenuSelect,scrollable:!0,showCheckmark:!1},{default:()=>ie})}}),a("div",{class:[`${n}-pagination-item`,!de&&`${n}-pagination-item--button`,{[`${n}-pagination-item--disabled`]:o<1||o>=i||t}],onClick:q},de?de({page:o,pageSize:f,pageCount:i,itemCount:this.mergedItemCount,startIndex:this.startIndex,endIndex:this.endIndex}):a($e,{clsPrefix:n},{default:()=>this.rtlEnabled?a(Ot,null):a(Tt,null)})));case"size-picker":return!d&&v?a(qn,Object.assign({consistentMenuWidth:!1,placeholder:"",showCheckmark:!1,to:this.to},this.selectProps,{size:x,options:s,value:f,disabled:t,theme:l.peers.Select,themeOverrides:l.peerOverrides.Select,onUpdateValue:B})):null;case"quick-jumper":return!d&&c?a("div",{class:`${n}-pagination-quick-jumper`},E?E():yt(this.$slots.goto,()=>[g.goto]),a(St,{value:u,onUpdateValue:O,size:b,placeholder:"",disabled:t,theme:l.peers.Input,themeOverrides:l.peerOverrides.Input,onChange:K})):null;default:return null}}),D?a("div",{class:`${n}-pagination-suffix`},D({page:o,pageSize:f,pageCount:i,startIndex:this.startIndex,endIndex:this.endIndex,itemCount:this.mergedItemCount})):null)}}),sn=S("ellipsis",{overflow:"hidden"},[rt("line-clamp",`
 white-space: nowrap;
