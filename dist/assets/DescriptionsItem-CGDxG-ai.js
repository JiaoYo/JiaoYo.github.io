import{aS as p,aT as e,bF as L,aU as S,aV as B,aX as G,aY as H,d as E,aZ as W,a_ as V,a as M,bo as k,b3 as K,dt as N,cV as U,aF as n,bA as X,cW as Y,du as Z}from"./index-ABwqYAX9.js";function D(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const F="DESCRIPTION_ITEM_FLAG";function q(r){return typeof r=="object"&&r&&!Array.isArray(r)?r.type&&r.type[F]:!1}const J=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
